...
const SignUp = () => {
  ...
  const handleGooglelogin = async (e) => {
        ...
        try {
            const usercreditional=  await signInWithPopup(auth, provider)
            ...
            console.log(usercreditional)
                  ...
                  if(isUserexist) {
                     toast.error("You have already User Please Log in ! ")
                    setLoading(false)
                    return
                  }else{
                    ...
                    setLoading(false);
                    toast.success("Google Sing up successful!");
        ...
        <div className="w-full max-w-md relative">
          <div className="bg-blue-900/30 backdrop-blur-sm p-6 sm:p-8 rounded-3xl border border-blue-800/50 shadow-xl relative overflow-hidden">
            ...
            <div className="ml-auto">
              ...
              <Link to={"/"}>  <h1 className="text-center text-blue-300">Already Have an Account ? Log in</h1> </Link>
